                                    ...
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <?php
                                            ...
                                            if ($resultCheck > 0)
                                            {
                                                ...
                                                {
                                                    echo '<div class="modal fade" id="modal'.$row['customer_id'].'">';
                                                    ?>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form action="./wrequestlogic.php" method="post">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input class="form-control" id="accNum" name="accNum" readonly="readonly" type="number" value="<?php echo $row["customer_id"]?>">
                                                                        </div>
